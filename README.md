...
paths, years and ratings, so a client draws a complete card without a per-result TMDB call. That sidecar
is a cache kept no longer than the six months TMDB's terms allow; no overviews and no raw text, and **nothing
